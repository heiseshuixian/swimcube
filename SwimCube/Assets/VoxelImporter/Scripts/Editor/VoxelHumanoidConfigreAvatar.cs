...
namespace VoxelImporter
{
    public class VoxelHumanoidConfigreAvatar : EditorWindow
    {
        ...
        #region GUIStyles
        private GUIStyle guiStyleBacgroundBox;
        ...
        {
            #region GUIStyle
            if (guiStyleBacgroundBox == null)
                guiStyleBacgroundBox = new GUIStyle("AnimationCurveEditorBackground");
            ...
            if (humanoidAvatarConfigreMode == HumanoidAvatarConfigreMode.Mapping)
            {
                #region Avatar Preview
                {
                    Rect backgroundRect;
                    {
                        ...
                        GUI.Box(backgroundRect, "", guiStyleBacgroundBox);
                    }
